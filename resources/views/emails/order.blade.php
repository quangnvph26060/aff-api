                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <img src="{{asset('logo/logo-affilate.jpg')}}" class="card-logo card-logo-dark" alt="logo dark" height="17">
                                    <!-- <img src="#" class="card-logo card-logo-light" alt="logo light" height="17"> -->
                                    <div class="mt-sm-5 mt-4">
                                        {{$order}}
                                        <h6 class="text-muted text-uppercase fw-semibold">Địa Chỉ</h6>
                                        <p class="text-muted mb-1" id="address-details">{{$user['address'] ?? ""}}</p>
