                    ...
                    <div class="card text-center">
                        <div class="card-body">
                            <label for="avatarInput">
                                <img src="{{ asset('/users/avatar-1.jpg') }}" alt="User Avatar"
                                    class="rounded-circle mb-3" width="150" height="150" style="cursor: pointer;">
                            </label>
                            <form action="{{ route('file.upload') }}" method="post" id="btn-upload"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="user-info-form" action="{{route('admin.profile.update')}}" method="POST">
                                ...
                                <button type="submit" id="update-info-btn" class="btn btn-outline-primary">Cập nhật
                                    thông tin</button>
