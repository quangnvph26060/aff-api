            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Danh sách gói tháng </h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                        <div class="card-header" style="">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                ...
                                                <input autocomplete="off" name="name" type="text" class="form-control"
                                                    placeholder="Tên gói" required id="name">
                            ...
                            <div style="float: right">
                                <a href="{{ route('admin.package.view') }}" class="btn btn-primary">Thêm gói</a>
                            </div>
                        </div>
                        @if (session('success'))
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a class="btn btn-warning"
                                                            href="{{ route('admin.package.edit', ['id'=> $value->id]) }}">Sửa</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
