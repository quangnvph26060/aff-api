...
<html lang="vi">
    <head>
        ...
        <!-- Bootstrap Css -->
        <link href="https://quanlycongviec.site/libs/assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="https://quanlycongviec.site/libs/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="https://quanlycongviec.site/libs/assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
    </head>
    <body>
