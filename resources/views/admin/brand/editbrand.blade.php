                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('admin.brand.update', ['id'=>$brand->id] ) }}" method="POST" id="submitfrom"
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input value="{{ $brand->name }}" required class="form-control" name="name" type="text"
                                                    id="name">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-search-input" class="form-label">Email <span
                                                        class="text text-danger">*</span></label>
                                                <input value="{{ $brand->email }}" required class="form-control" name="email" type="email"
                                                    id="email">
                                                <div class="col-lg-9"><span class="invalid-feedback d-block"
                                            ...
                                            <div class="mb-3">
                                                <label for="example-url-input" class="form-label">Địa chỉ <span
                                                        class="text text-danger">*</span></label>
                                                <input value="{{ $brand->address }}" required class="form-control" name="address"
                                            ...
                                            <div class="mb-3">
                                                <label for="example-url-input" class="form-label">Số điện thoại <span
                                                        class="text text-danger">*</span></label>
                                                <input value="{{ $brand->phone }}" required class="form-control" name="phone"
                                                    type="text" id="phone" >
                                                <div class="col-lg-9"><span class="invalid-feedback d-block"
